...
import (
	...
	"github.com/IguoChan/redis-operator/internal/controller"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "be461ab9.iguochan.io",
	...
	if err = (&controller.RedisSentinelReconciler{
		Client:   mgr.GetClient(),
		Scheme:   mgr.GetScheme(),
		Recorder: mgr.GetEventRecorderFor("RedisSentinel"),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "RedisSentinel")
		os.Exit(1)
	}
	if err = (&cachev1.RedisSentinel{}).SetupWebhookWithManager(mgr); err != nil {
